...
var SceneDialogSpriteDialogMsg1 = (function () {
    ...
    SceneDialogSpriteDialogMsg1.prototype.updateText = function (spr, speed, more) {
        var _this = this;
        ...
        if (spr.custom && spr.custom.content) {
            ...
            if (spr.custom.content.length > len) {
                ...
                spr.scene.timeout(10 * (100 / textSpeed), function () { return _this.updateText(spr, textSpeed, more); });
            }
    ...
    SceneDialogSpriteDialogMsg1.prototype.onDisplayDone = function (spr) {
