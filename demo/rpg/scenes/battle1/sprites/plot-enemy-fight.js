...
exports.PlotEnemyFight = void 0;
var PlotEnemyFight = (function () {
    function PlotEnemyFight() {
    }
    PlotEnemyFight.prototype.onUpdate = function (sprite) {
        var scene, tween, motion, profile, fighter, fighterDisplay, enemy, enemyDisplay, enemyAnimation, effect, effectDisplay, effectAnimation, hurt, hurtDisplay, damage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fighter = scene.spr("enemy1");
                    fighterDisplay = fighter.get("display").object;
                    enemy = scene.spr("fighter1");
                    enemyDisplay = enemy.get("display").object;
                    enemyAnimation = enemy.get("display").animation;
                ...
                case 1:
                    ...
                    enemyAnimation.onComplete = function () { return sprite.plot.signal("end1"); };
                ...
                case 3:
                    ...
                    return [4, sprite.plot.wait("end2")];
                case 4:
                    _a.sent();
    ...
    return PlotEnemyFight;
}());
exports.PlotEnemyFight = PlotEnemyFight;

//# sourceMappingURL=plot-enemy-fight.js.map
