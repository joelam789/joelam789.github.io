...
var RpgMap = (function () {
    ...
    RpgMap.prototype.init = function (game) {
        this.profile = game.components.rpg;
        console.log("rpg-map system is loaded successfully");
        return true;
    };
    RpgMap.prototype.activate = function (scene) {
        this.player = null;
        this.dialog = null;
        this.holdon = false;
    ...
    RpgMap.prototype.update = function (scene, time) {
        this.handleKeyboard(scene);
    };
    RpgMap.prototype.checkMovementControl = function () {
        if (!this.keyboard)
            return null;
    ...
    RpgMap.prototype.checkActionControl = function () {
        if (!this.keyboard)
            return null;
    ...
    RpgMap.prototype.cleanupMap = function (scene) {
        var rpg = scene.components["rpg"];
        if (!rpg)
            return;
        if (rpg.tempMarks) {
    ...
    RpgMap.prototype.occupyTile = function (spr, tileX, tileY) {
    ...
    RpgMap.prototype.leaveTile = function (spr, tileX, tileY) {
        var rpg = spr.scene.components["rpg"];
        var gamemap = spr.scene.get("stage").gamemap;
        if (gamemap && rpg && rpg.tempMarks) {
            var key = tileX + "_" + tileY;
    ...
    RpgMap.prototype.occupyCurrentTile = function (spr) {
        var rpg = spr.scene.components["rpg"];
        var gamemap = spr.scene.get("stage").gamemap;
        if (gamemap && rpg && rpg.tempMarks) {
    ...
    RpgMap.prototype.isOccupiedTile = function (scene, exceptNames, tileX, tileY) {
        var rpg = scene.components["rpg"];
    ...
    RpgMap.prototype.alignToTile = function (spr) {
        var gamemap = spr.scene.get("stage").gamemap;
        if (gamemap) {
    ...
    RpgMap.prototype.getDirection = function (pos, next) {
        if (pos.x == next.x) {
            if (pos.y > next.y)
                return "up";
    ...
    RpgMap.prototype.getCurrentTile = function (spr) {
        var gamemap = spr.scene.get("stage").gamemap;
        if (gamemap) {
            var posX = spr.get("stage").x;
            var posY = spr.get("stage").y;
    ...
    RpgMap.prototype.getNextTile = function (spr) {
    ...
    RpgMap.prototype.getPlotOnTile = function (scene, x, y) {
    ...
    RpgMap.prototype.getPlotNpc = function (plot) {
    ...
    RpgMap.prototype.startNpcWaiting = function (npc) {
        var state = npc.get("movement");
        if (state)
            state.waiting = true;
    };
    RpgMap.prototype.stopNpcWaiting = function (scene) {
        var gamemap = scene.get("stage").gamemap;
        if (!gamemap)
            return null;
        for (var item in scene.sprites) {
    ...
    RpgMap.prototype.isNpcWalking = function (npc) {
        var state = npc.get("movement");
        return state && (state.moving || state.walking);
    };
    RpgMap.prototype.isTalking = function () {
        return this.dialog && this.dialog.active;
    };
    RpgMap.prototype.isAnswering = function () {
        return this.dialog && this.dialog.active
            && this.dialog.code && this.dialog.code.isAnswering();
    };
    RpgMap.prototype.selectAnswer = function () {
        if (this.dialog && this.dialog.active && this.dialog.code)
            this.dialog.code.selectAnswer();
    };
    RpgMap.prototype.onSceneMapClick = function (scene, event) {
    ...
    RpgMap.prototype.handleKeyboard = function (scene) {
        var _this = this;
        if (scene.paused)
            return;
...
//# sourceMappingURL=rpg-map.js.map
